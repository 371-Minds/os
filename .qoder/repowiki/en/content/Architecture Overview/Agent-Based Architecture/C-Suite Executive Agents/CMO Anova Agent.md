...
- [cmo_anova.py](file://legacy/_legacy/agents/business/cmo_anova.py) - *Updated in recent commit*
- [cmo-agent-prompt.json](file://core/questflow/agents/core/cmo-agent-prompt.json) - *Configuration for CMO agent*
- [content-generation-agent.json](file://core/questflow/agents/specialized/content-generation-agent.json) - *Content generation agent configuration*
- [marketing-automation-agent.json](file://core/questflow/agents/specialized/marketing-automation-agent.json) - *Marketing automation agent configuration*
- [intelligent_router_agent.py](file://legacy/_legacy/adaptive_llm_router/intelligent_router_agent.py) - *Adaptive LLM Router logic*
- [llm.py](file://legacy/_legacy/adaptive_llm_router/llm.py) - *LLM invocation and provider selection*
</cite>

## Update Summary
**Changes Made**   
- Updated file paths to reflect current repository structure
- Enhanced documentation of CMO Anova Agent's role in campaign orchestration
- Added details on integration with content_generation_agent and marketing_automation_agent
- Expanded explanation of Adaptive LLM Router usage for audience segmentation
- Included configuration details from agent prompt files
- Updated code examples to reflect actual implementation
- Added troubleshooting guidance for low engagement scenarios
...
**Diagram sources**
- [cmo_anova.py](file://legacy/_legacy/agents/business/cmo_anova.py)
- [marketing-automation-agent.json](file://core/questflow/agents/specialized/marketing-automation-agent.json)
- [content-generation-agent.json](file://core/questflow/agents/specialized/content-generation-agent.json)
...
**Section sources**
- [cmo_anova.py](file://legacy/_legacy/agents/business/cmo_anova.py#L15-L30)
...
- [cmo_anova.py](file://legacy/_legacy/agents/business/cmo_anova.py)
- [marketing-automation-agent.json](file://core/questflow/agents/specialized/marketing-automation-agent.json)
- [intelligent_router_agent.py](file://legacy/_legacy/adaptive_llm_router/intelligent_router_agent.py)
...
**Diagram sources**
- [cmo_anova.py](file://legacy/_legacy/agents/business/cmo_anova.py#L15-L50)

**Section sources**
- [cmo_anova.py](file://legacy/_legacy/agents/business/cmo_anova.py#L1-L100)
...
**Diagram sources**
- [marketing-automation-agent.json](file://core/questflow/agents/specialized/marketing-automation-agent.json#L200-L279)

**Section sources**
- [marketing-automation-agent.json](file://core/questflow/agents/specialized/marketing-automation-agent.json#L1-L279)
...
**Diagram sources**
- [content-generation-agent.json](file://core/questflow/agents/specialized/content-generation-agent.json#L15-L60)

**Section sources**
- [content-generation-agent.json](file://core/questflow/agents/specialized/content-generation-agent.json#L1-L63)
...
**Diagram sources**
- [intelligent_router_agent.py](file://legacy/_legacy/adaptive_llm_router/intelligent_router_agent.py#L1-L100)
- [llm.py](file://legacy/_legacy/adaptive_llm_router/llm.py#L1-L42)

**Section sources**
- [intelligent_router_agent.py](file://legacy/_legacy/adaptive_llm_router/intelligent_router_agent.py#L1-L104)
- [llm.py](file://legacy/_legacy/adaptive_llm_router/llm.py#L1-L42)
...
**Section sources**
- [cmo_anova.py](file://legacy/_legacy/agents/business/cmo_anova.py#L50-L80)
- [marketing-automation-agent.json](file://core/questflow/agents/specialized/marketing-automation-agent.json#L250-L279)
