      ...
      <div className="footer-container">
        <div className="footer-content">
          <div className="company-info">
            {companyLogo && (
              <img src={companyLogo} alt={companyName} className="footer-logo" />
            )}
            ...
            <div className="social-links">
              ...
              <div className="social-icons">
                {socialLinks.facebook && (
                  <a href={socialLinks.facebook} className="social-link facebook">Facebook</a>
                )}
                {socialLinks.twitter && (
                ...
                {socialLinks.instagram && (
                  <a href={socialLinks.instagram} className="social-link instagram">Instagram</a>
                )}
              </div>
            </div>
          )}
