    ...
    >
      ...
      <div style={{ padding: '20px', backgroundColor: '#1a1a1a' }}>
        <p style={{ fontSize: '16px', marginTop: '0', textAlign: 'center' }}>
          Incredible work,{' '}
          <strong style={{ color: style.backgroundColor }}>{gamerTag}</strong>!
        </p>
        ...
        >
          <h4 style={{ color: '#4a69bd', marginTop: '0' }}>
            📊 Achievement Stats
          </h4>
          <div
            style={{
          ...
          >
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '24px', color: style.backgroundColor }}>
                {style.icon}
              </div>
        ...
        >
          ...
          >
            ...
            <li>
              Join community events for exclusive achievement opportunities
            </li>
            <li>Team up with friends to unlock social achievements faster</li>
            <li>
              Rare achievements often require specific conditions - read the
              hints!
            </li>
          </ul>
        </div>
        ...
        <p>
          This achievement represents your dedication and skill, {gamerTag}.
          You've proven that you have what it takes to reach new heights in
          gaming. We're excited to see what you'll accomplish next!
        </p>

        <p>
          Keep achieving greatness,
          <br />
          <strong style={{ color: style.backgroundColor }}>
            The EpicQuestHub Team
          </strong>
        </p>
