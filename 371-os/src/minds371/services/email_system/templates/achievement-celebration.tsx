  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', maxWidth: '600px', margin: '0 auto' }}>
      ...
      <div style={{ padding: '0 20px' }}>
        <p style={{ fontSize: '16px', marginTop: '20px' }}>Dear {parentName},</p>
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <strong>Program:</strong> {programName} | <strong>Date:</strong> {dateAchieved}
          </div>
        </div>
        
        <h3 style={{ color: '#4a90e2' }}>New Skills Unlocked!</h3>
        <div style={{ backgroundColor: '#f0f8ff', padding: '20px', borderRadius: '8px', margin: '15px 0' }}>
        ...
        {nextGoal && (
          <div style={{ backgroundColor: '#e8f5e8', padding: '15px', borderRadius: '5px', margin: '20px 0' }}>
            <h4 style={{ color: '#28a745', marginTop: '0' }}>🎯 Next Adventure</h4>
        ...
        {certificateUrl && (
          <div style={{ 
            ...
            <h4 style={{ margin: '0 0 10px 0' }}>📜 Digital Certificate Available</h4>
            <a 
              href={certificateUrl} 
              style={{ 
                color: 'white', 
        ...
        <div style={{ backgroundColor: '#f8f9fa', padding: '20px', borderRadius: '8px', margin: '20px 0' }}>
          <h4 style={{ color: '#495057', marginTop: '0' }}>💡 Celebrate This Moment</h4>
          <p style={{ margin: '0 0 15px 0', color: '#495057' }}>
            This achievement represents hours of dedication, creativity, and growth. 
        ...
        <p>
          We're so proud of {studentName} and excited to continue supporting their learning journey. 
          Thank you for being such wonderful partners in their education!
        </p>
        ...
        <div style={{ marginTop: '30px', padding: '15px', backgroundColor: '#e3f2fd', borderRadius: '5px' }}>
          <p style={{ margin: '0', fontSize: '14px', color: '#666' }}>
            <strong>IkidEdventures</strong> - Celebrating Every Step of the Learning Journey
          </p>
        </div>
      </div>
    </div>
