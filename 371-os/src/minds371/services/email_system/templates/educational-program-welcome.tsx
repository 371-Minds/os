...
export const EducationalProgramWelcome: React.FC<
  EducationalProgramWelcomeProps
> = ({
  studentName,
  parentName,
  programName,
  ...
  return (
    ...
    >
      ...
      <p>
        We're thrilled to welcome {studentName} to the{' '}
        <strong>{programName}</strong> program! This marks the beginning of an
        exciting educational adventure that will inspire creativity, critical
      ...
      >
        ...
        <ul style={{ listStyle: 'none', padding: '0' }}>
          ...
          <li>
            <strong>Duration:</strong> {programDuration}
          </li>
          <li>
            <strong>Lead Instructor:</strong> {instructorName}
          </li>
        </ul>
      </div>
      ...
      <ul>
        <li>
          🎯 Personalized learning experiences tailored to your child's
          interests
        </li>
      ...
      >
        ...
        <p style={{ margin: '0', color: '#856404' }}>
          Please ensure {studentName} has access to their learning materials and
          check your email regularly for program updates and progress reports.
        </p>
      </div>

      <p>
        We're excited to be part of {studentName}'s educational journey and look
        forward to watching them grow, learn, and achieve amazing things!
      </p>
