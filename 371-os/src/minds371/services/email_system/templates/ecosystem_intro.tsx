...
export const EcosystemIntro: React.FC<EcosystemIntroProps> = ({
  ...
  const getContextTitle = (context: string) => {
    switch (context) {
      ...
      case 'partner': return 'Partnership Opportunity';
      case 'client': return 'Service Portfolio';
      case 'talent': return 'Career Opportunities';
      default: return 'Ecosystem Overview';
    }
  };
  ...
  const getStageColor = (stage: string) => {
    switch (stage) {
      case 'Startup': return '#ff6b6b';
      case 'Growth': return '#4ecdc4';
      case 'Scale': return '#45b7d1';
      case 'Mature': return '#96ceb4';
    ...
    <div style={{ fontFamily: 'Arial, sans-serif', maxWidth: '700px', margin: '0 auto', backgroundColor: '#f8f9fa', color: '#212529' }}>
      ...
      <div style={{ padding: '30px', backgroundColor: '#ffffff' }}>
        <p style={{ fontSize: '18px', marginTop: '0' }}>
          Dear {recipientName}{recipientTitle && `, ${recipientTitle}`}{recipientCompany && ` at ${recipientCompany}`},
        </p>
        
        <p style={{ fontSize: '16px', lineHeight: '1.6' }}>
          Thank you for your interest in 371 Minds. We're excited to introduce you to our 
          innovative ecosystem of companies that are reshaping industries and driving technological advancement.
        </p>
        ...
        <div style={{ 
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '20px', margin: '25px 0' }}>
            <div style={{ 
              ...
              <h3 style={{ color: '#1976d2', margin: '0 0 10px 0', fontSize: '16px' }}>
                Portfolio Companies
              </h3>
        ...
        <h3 style={{ color: '#212529', marginBottom: '25px', fontSize: '26px' }}>🏢 Portfolio Companies</h3>
        ...
        {portfolioCompanies.map((company, index) => (
          <div key={index} style={{ 
            ...
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '15px' }}>
              {company.logo && (
                <img 
                  ...
                  style={{ width: '60px', height: '60px', marginRight: '20px', borderRadius: '10px' }}
                />
              )}
              <div style={{ flex: 1 }}>
                <h4 style={{ color: '#212529', margin: '0 0 5px 0', fontSize: '24px' }}>
                  {company.name}
                </h4>
            ...
            <p style={{ fontSize: '16px', lineHeight: '1.6', margin: '15px 0', color: '#495057' }}>
              {company.description}
            </p>
            ...
            <div style={{ 
              ...
              <h5 style={{ color: '#495057', margin: '0 0 8px 0', fontSize: '16px' }}>📊 Key Metrics:</h5>
        ...
        <div style={{ 
          ...
          <h3 style={{ color: '#155724', marginTop: '0', fontSize: '22px' }}>🌟 Ecosystem Benefits</h3>
          <ul style={{ margin: '0', paddingLeft: '20px', lineHeight: '1.8' }}>
            {ecosystemBenefits.map((benefit, index) => (
              <li key={index} style={{ margin: '8px 0', fontSize: '16px', color: '#155724' }}>
                {benefit}
              </li>
            ))}
          </ul>
        ...
        <h3 style={{ color: '#212529', marginBottom: '20px', fontSize: '24px' }}>🏆 Success Stories</h3>
        ...
        {successStories.map((story, index) => (
          <div key={index} style={{ 
            ...
            <h4 style={{ color: '#856404', margin: '0 0 15px 0', fontSize: '20px' }}>
              {story.title}
            </h4>
            ...
            <div style={{ 
              ...
              <h5 style={{ color: '#856404', margin: '0 0 8px 0', fontSize: '16px' }}>💡 Impact:</h5>
              <p style={{ margin: '0', fontSize: '14px', color: '#6c757d' }}>
                {story.impact}
              </p>
            </div>
        ...
        <h3 style={{ color: '#212529', marginBottom: '20px', fontSize: '24px' }}>🎯 Next Steps</h3>
        ...
        <div style={{ 
          ...
          {nextSteps.map((step, index) => (
            <div key={index} style={{ 
              ...
              <p style={{ margin: '0', color: '#495057', fontSize: '16px', lineHeight: '1.6' }}>
                {step.description}
              </p>
            </div>
          ))}
        ...
        <div style={{ 
          ...
          <p style={{ margin: '0 0 15px 0', fontSize: '16px', lineHeight: '1.6' }}>
            Ready to explore how 371 Minds can add value to your {introductionContext === 'investor' ? 'investment portfolio' : 
            introductionContext === 'partner' ? 'business partnerships' : 
            introductionContext === 'client' ? 'business operations' : 'career journey'}?
          </p>
          <div style={{ 
            backgroundColor: '#ffffff',
            color: '#17a2b8',
        ...
        <p style={{ fontSize: '16px', lineHeight: '1.6' }}>
          We're excited about the possibility of working together and look forward to 
          discussing how our ecosystem can create value for your organization.
        </p>
        ...
        <div style={{ marginTop: '40px', padding: '20px', backgroundColor: '#f8f9fa', borderRadius: '8px', textAlign: 'center' }}>
          <p style={{ margin: '0', fontSize: '16px', color: '#6c757d' }}>
            <strong style={{ color: '#212529' }}>371 Minds</strong> - Building the Future Together
          </p>
