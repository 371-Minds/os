...
export const LaunchAnnouncement: React.FC<LaunchAnnouncementProps> = ({
  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', maxWidth: '600px', margin: '0 auto' }}>
      ...
      <p>
        We're excited to announce the official launch of <strong>Legacy Code Archaeologist</strong> - 
        your specialized partner for modernizing and understanding legacy codebases.
      </p>
      ...
      <p>
        Whether you're dealing with decades-old COBOL systems, tangled PHP applications, 
        or monolithic Java architectures, we have the expertise to help you navigate 
        the complexities of legacy modernization.
      </p>
      ...
      <p>
        Ready to unearth the potential in your legacy systems? Let's start the archaeological dig!
      </p>
