...
async function testMongoDBConnection() {
    ...
    try {
        ...
        if (localConnected) {
            ...
            console.log('💾 Save agent data:', saveResult ? '✅ Success' : '❌ Failed');
            
            const retrievedAgent = await mongodb371.getAgentData(testAgent.agentId);
            console.log('📖 Retrieve agent data:', retrievedAgent ? '✅ Success' : '❌ Failed');
            ...
            console.log('📈 Save business intelligence:', biResult ? '✅ Success' : '❌ Failed');
            ...
            console.log('📧 Save communication event:', eventResult ? '✅ Success' : '❌ Failed');
        ...
        // Connection summary
        console.log('\n📋 Connection Summary:');
        console.log(`   Local URI: ${process.env.MONGODB_LOCAL_URI || 'mongodb://localhost:27017/os371'}`);
        console.log(`   Akash URI: ${process.env.MONGODB_AKASH_URI || 'Not configured'}`);
