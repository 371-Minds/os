...
export const ConsultationBooking: React.FC<ConsultationBookingProps> = ({
  ...
  const getConsultationTitle = (type: string) => {
    switch (type) {
      case 'initial':
        return 'Initial Legacy Assessment';
      case 'technical':
        return 'Technical Deep Dive';
      case 'strategic':
        return 'Strategic Modernization Planning';
      default:
        return 'Legacy Code Consultation';
    }
  };
  ...
  return (
    ...
    >
      ...
      <p>
        Thank you for your interest in Legacy Code Archaeologist's consulting
        services. We're ready to help {companyName} navigate the complexities of
      ...
      <p>
        Don't see a time that works? Reply to this email and we'll find a slot
        that fits your schedule.
      </p>

      <p>
        We're excited to learn about your legacy systems and discuss how we can
        help {companyName}
      ...
      <p style={{ fontSize: '12px', color: '#666' }}>
        All consultations are conducted via secure video conference. You'll
        receive meeting details after booking.
      </p>
    </div>
  );
};
