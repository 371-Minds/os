    ...
    >
      ...
      <div style={{ padding: '30px', backgroundColor: '#ffffff' }}>
        ...
        <p style={{ fontSize: '16px', lineHeight: '1.6' }}>
          Welcome to our cross-company ecosystem update! This report highlights
          the incredible synergies, collaborations, and shared successes across
          our portfolio companies. Together, we're building something greater
        ...
        {crossCompanyInitiatives.map((initiative, index) => (
          ...
          >
            ...
            <div style={{ margin: '15px 0' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
                {initiative.participatingCompanies.map(
        ...
        >
          ...
          <p style={{ margin: '0', fontSize: '16px', lineHeight: '1.6' }}>
            Our ecosystem approach continues to drive innovation, reduce costs,
            and accelerate growth across all portfolio companies. By sharing
            resources, knowledge, and opportunities, we're creating sustainable
            competitive advantages that benefit everyone.
          </p>
        </div>

        <p style={{ fontSize: '16px', lineHeight: '1.6' }}>
          The synergies across our portfolio continue to exceed expectations.
          We're excited about the momentum building and look forward to sharing
          more collaborative successes in the coming months.
        </p>
