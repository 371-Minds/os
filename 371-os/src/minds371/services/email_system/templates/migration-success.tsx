  ...
  return (
    ...
    >
      <div style={{ textAlign: 'center', marginBottom: '30px' }}>
        <h1
          style={{ color: '#27ae60', fontSize: '28px', marginBottom: '10px' }}
        >
          🎉 Migration Complete!
        </h1>
      ...
      <p>
        Congratulations! We're thrilled to announce the successful completion of
        the
        <strong> {projectName}</strong> modernization project at {companyName}.
        Your legacy system has been transformed into a modern, maintainable
        solution.
      </p>
      ...
      >
        <h3 style={{ color: '#1e8449', marginTop: '0' }}>
      ...
      >
        ...
        <p style={{ margin: '10px 0' }}>
          Special thanks to our dedicated team members who made this success
          possible:
        </p>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
      ...
      <p>
        Your modernized system is now ready for the future. We're proud to have
        been part of
        {companyName}'s digital transformation journey and look forward to
        supporting your continued success.
      </p>

      <p>
        Thank you for trusting Legacy Code Archaeologist with your critical
        modernization project. We're here whenever you need us for future
        enhancements or new challenges.
      </p>

      <p>Congratulations once again on this major achievement!</p>
