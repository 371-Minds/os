...
export const ParentNotification: React.FC<ParentNotificationProps> = ({
  ...
  const getNotificationStyle = () => {
    switch (notificationType) {
      ...
      case 'alert':
        return { backgroundColor: '#f8d7da', borderColor: '#f5c6cb', iconColor: '#dc3545', icon: '⚠️' };
      case 'celebration':
  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', maxWidth: '600px', margin: '0 auto' }}>
      ...
      <div style={{ 
        ...
        <h3 style={{ color: style.iconColor, marginTop: '0', display: 'flex', alignItems: 'center' }}>
      ...
      {actionRequired && (
        <div style={{ backgroundColor: '#f8f9fa', padding: '15px', borderRadius: '5px', margin: '15px 0' }}>
          ...
          {dueDate && (
            <p style={{ margin: '10px 0 0 0', color: '#dc3545', fontWeight: 'bold' }}>
              ⏳ Due Date: {dueDate}
            </p>
          )}
        </div>
      ...
      {additionalInfo && (
        <div style={{ backgroundColor: '#e9ecef', padding: '15px', borderRadius: '5px', margin: '15px 0' }}>
          <h4 style={{ color: '#495057', marginTop: '0' }}>Additional Information</h4>
          <p style={{ margin: '0', color: '#495057' }}>
            {additionalInfo}
          </p>
        </div>
      ...
      <p>
        We appreciate your continued support in {studentName}'s educational journey. 
      ...
      <div style={{ marginTop: '30px', padding: '15px', backgroundColor: '#e3f2fd', borderRadius: '5px' }}>
        <p style={{ margin: '0', fontSize: '14px', color: '#666' }}>
          <strong>IkidEdventures</strong> - Keeping Parents Connected to Their Child's Learning
        </p>
        <p style={{ margin: '5px 0 0 0', fontSize: '12px', color: '#999' }}>
          For urgent matters, please contact us directly at support@ikidedventures.com
        </p>
      </div>
    </div>
  );
