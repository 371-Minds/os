  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', maxWidth: '600px', margin: '0 auto', backgroundColor: '#0a0a0a', color: '#ffffff' }}>
      ...
      <div style={{ padding: '20px', backgroundColor: '#1a1a1a' }}>
        <div style={{ 
          ...
          {nominatedBy && (
            <div style={{ fontSize: '14px', color: '#999', marginTop: '10px' }}>
              Nominated by: <span style={{ color: '#00ff88' }}>{nominatedBy}</span>
            </div>
          )}
        </div>
        ...
        <div style={{ backgroundColor: '#2a2a2a', padding: '20px', borderRadius: '8px', margin: '20px 0' }}>
          ...
          {quote && (
            <div style={{ 
              ...
              <div style={{ textAlign: 'right', marginTop: '10px', fontSize: '14px', color: '#999' }}>
                - {featuredGamerTag}
              </div>
            </div>
          )}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: '15px', margin: '20px 0' }}>
          <div style={{ backgroundColor: '#2a2a2a', padding: '15px', borderRadius: '8px', textAlign: 'center' }}>
            <div style={{ fontSize: '24px', marginBottom: '5px' }}>🎯</div>
            <div style={{ fontSize: '12px', color: '#999', marginBottom: '5px' }}>QUESTS</div>
            <div style={{ fontWeight: 'bold', color: '#00ff88' }}>{stats.totalQuests}</div>
          </div>
          <div style={{ backgroundColor: '#2a2a2a', padding: '15px', borderRadius: '8px', textAlign: 'center' }}>
            <div style={{ fontSize: '24px', marginBottom: '5px' }}>🏆</div>
            <div style={{ fontSize: '12px', color: '#999', marginBottom: '5px' }}>WIN RATE</div>
            <div style={{ fontWeight: 'bold', color: '#ffd700' }}>{stats.winRate}</div>
          </div>
          <div style={{ backgroundColor: '#2a2a2a', padding: '15px', borderRadius: '8px', textAlign: 'center' }}>
            <div style={{ fontSize: '24px', marginBottom: '5px' }}>📊</div>
            <div style={{ fontSize: '12px', color: '#999', marginBottom: '5px' }}>RANK</div>
            <div style={{ fontWeight: 'bold', color: '#ff6b6b' }}>#{stats.communityRank}</div>
          </div>
          <div style={{ backgroundColor: '#2a2a2a', padding: '15px', borderRadius: '8px', textAlign: 'center' }}>
            <div style={{ fontSize: '24px', marginBottom: '5px' }}>📅</div>
            <div style={{ fontSize: '12px', color: '#999', marginBottom: '5px' }}>MEMBER SINCE</div>
            <div style={{ fontWeight: 'bold', color: '#4a69bd' }}>{stats.joinDate}</div>
          </div>
        </div>
        ...
        {socialLinks && (Object.keys(socialLinks).length > 0) && (
          <>
            <h3 style={{ color: '#00ff88' }}>🔗 Connect with {featuredGamerTag}</h3>
            <div style={{ backgroundColor: '#2a2a2a', padding: '20px', borderRadius: '8px', margin: '15px 0' }}>
        ...
        <div style={{ 
          ...
          <h3 style={{ color: '#00ff88', marginTop: '0' }}>🌟 Want to be Featured?</h3>
          <p style={{ margin: '10px 0', color: '#cccccc' }}>
            Our community spotlight celebrates gamers who make EpicQuestHub an amazing place to be. 
            Whether through exceptional gameplay, helping others, or contributing to our community spirit, 
            we want to recognize your achievements!
          </p>
          <ul style={{ margin: '10px 0', paddingLeft: '20px', color: '#cccccc', lineHeight: '1.6' }}>
        ...
        {nextSpotlightDate && (
          <div style={{ backgroundColor: '#2a2a2a', padding: '15px', borderRadius: '8px', margin: '20px 0', textAlign: 'center' }}>
            <h4 style={{ color: '#ffd700', marginTop: '0' }}>📅 Next Spotlight</h4>
            <p style={{ margin: '0', color: '#cccccc' }}>
              Our next community spotlight will be featured on <strong>{nextSpotlightDate}</strong>. 
              Could it be you?
            </p>
          </div>
        )}
        ...
        <p>
          Congratulations to {featuredGamerTag} for being an outstanding member of our community! 
          Your dedication, skills, and positive spirit inspire us all. Thank you for making 
          EpicQuestHub a better place for everyone.
        </p>
        ...
        <div style={{ marginTop: '30px', padding: '15px', backgroundColor: '#2a2a2a', borderRadius: '5px', textAlign: 'center' }}>
          <p style={{ margin: '0', fontSize: '14px', color: '#cccccc' }}>
            <strong style={{ color: '#ffd700' }}>EpicQuestHub Community</strong> - Powered by Amazing Gamers Like You
          </p>
