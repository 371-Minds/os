  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '20px', backgroundColor: '#1a1a1a' }}>
        ...
        <p>
          Welcome to the ultimate gaming community! We're stoked to have{' '}
          <strong style={{ color: '#00ff88' }}>{gamerTag}</strong> join our
          ranks. Get ready to embark on epic quests, dominate tournaments, and
          connect with fellow gamers who share your passion for gaming
          excellence.
        </p>
        ...
        >
          ...
          <div style={{ display: 'grid', gap: '8px' }}>
            <div>
              ...
              <span style={{ color: '#00ff88' }}>{gamerTag}</span>
            </div>
            <div>
            ...
            <div>
              ...
              <span style={{ color: '#ffd700' }}>{skillLevel}</span>
            </div>
            <div>
              <strong>Welcome Bonus:</strong>{' '}
              <span style={{ color: '#ff6b6b' }}>{welcomeBonus}</span>
            </div>
          </div>
        </div>
        ...
        >
          <h3 style={{ color: '#4a69bd', marginTop: '0' }}>
          ...
          <p style={{ margin: '0', color: '#cccccc' }}>
            Complete this quest to earn your first achievement and unlock
            exclusive rewards!
          </p>
        </div>
        ...
        <p>
          Ready to dominate? Your gaming destiny awaits at EpicQuestHub. Let's
          make some epic memories together!
        </p>
        ...
        >
          <p style={{ margin: '0', fontSize: '14px', color: '#cccccc' }}>
            <strong style={{ color: '#00ff88' }}>EpicQuestHub</strong> - Where
            Legends Are Born
          </p>
