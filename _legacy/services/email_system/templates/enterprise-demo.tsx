...
export const EnterpriseDemo: React.FC<EnterpriseDemoProps> = ({
  ...
  return (
    ...
    >
      ...
      <p>
        Thank you for your interest in Legacy Code Archaeologist's enterprise
        solutions. We're excited to show you how we can help {companyName}{' '}
        modernize your legacy systems and unlock hidden value in your existing
        codebase.
      </p>
      ...
      >
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <tr>
            <td style={{ padding: '8px 0', fontWeight: 'bold', width: '30%' }}>
              Date:
            </td>
          ...
          <tr>
            ...
            <td style={{ padding: '8px 0' }}>
              <a href={meetingLink} style={{ color: '#3498db' }}>
                Join Demo Session
              </a>
            </td>
          </tr>
      ...
      >
        ...
        <ul style={{ margin: '10px 0', paddingLeft: '20px' }}>
          <li>
            <strong>Live Code Analysis:</strong> Real-time demonstration of our
            legacy code scanning tools
          </li>
          <li>
            <strong>Modernization Roadmaps:</strong> How we create actionable
            migration strategies
          </li>
          <li>
            <strong>ROI Calculator:</strong> Quantifying the business value of
            modernization
          </li>
          <li>
            <strong>Case Studies:</strong> Success stories from similar
            enterprise clients
          </li>
          <li>
            <strong>Integration Options:</strong> How we fit into your existing
            development workflow
          </li>
          <li>
            <strong>Custom Solutions:</strong> Tailored approaches for your
      ...
      <p>
        Need to reschedule or have questions before the demo? Feel free to reach
        out to {contactPerson} at {contactEmail}.
      </p>

      <p>
        We look forward to showing you how Legacy Code Archaeologist can help{' '}
        {companyName}
