...
- [cto_alex.py](file://legacy\_legacy\agents\business\cto_alex.py) - *Core implementation of CTO Alex Agent*
- [cto_alex.md](file://legacy\_legacy\agents\business\cto_alex.md) - *Benchmark test cases and expected behavior*
- [base_agent.py](file://legacy\_legacy\agents\base_agent\base_agent.py) - *Base class and foundational agent capabilities*
- [Adaptive_Router_Logic.md](file://legacy\_legacy\adaptive_llm_router\Adaptive_Router_Logic.md) - *Documentation for adaptive LLM routing logic*
- [CTO_Agent_Logic.md](file://legacy\_legacy\CTO_Agent_Logic.md) - *Architectural design and decision-making principles*
- [deployment_agent.py](file://legacy\_legacy\agents\technical\deployment_agent.py) - *Integration point for infrastructure deployment*
- [code_mern_agent.py](file://legacy\_legacy\agents\technical\code_mern_agent.py) - *Integration point for MERN stack development*
- [qa_agent.py](file://legacy\_legacy\agents\technical\qa_agent.py) - *Integration point for quality assurance and testing*
- [adaptive_llm_router_results.md](file://legacy\_legacy\adaptive_llm_router\adaptive_llm_router_results.md) - *Test results for LLM provider selection*
- [llm.py](file://legacy\_legacy\adaptive_llm_router\llm.py) - *Main entry point for Adaptive LLM Router*
- [policy_engine.py](file://legacy\_legacy\adaptive_llm_router\policy_engine.py) - *Decision logic for provider selection*
- [provider_registry.py](file://legacy\_legacy\adaptive_llm_router\provider_registry.py) - *Management of available LLM providers*
- [providers.json](file://legacy\_legacy\adaptive_llm_router\providers.json) - *Configuration of LLM provider costs and capabilities*
- [budget_guard.py](file://legacy\_legacy\adaptive_llm_router\budget_guard.py) - *Budget management and enforcement*
- [config.py](file://legacy\_legacy\adaptive_llm_router\config.py) - *Monthly budget cap configuration*
- [THINNG_ARCHITECTURAL_ENHANCEMENTS.md](file://THINNG_ARCHITECTURAL_ENHANCEMENTS.md) - *Updated in recent commit with mathematical precision enhancements*
</cite>
...
- Incorporated mathematical precision enhancements from thi.ng integration for agent positioning and business entity modeling
...
**Diagram sources**
- [cto_alex.py](file://legacy\_legacy\agents\business\cto_alex.py)
- [deployment_agent.py](file://legacy\_legacy\agents\technical\deployment_agent.py)
- [adaptive_llm_router_results.md](file://legacy\_legacy\adaptive_llm_router\adaptive_llm_router_results.md)
...
**Diagram sources**
- [cto_alex.py](file://legacy\_legacy\agents\business\cto_alex.py)
- [code_mern_agent.py](file://legacy\_legacy\agents\technical\code_mern_agent.py)
- [deployment_agent.py](file://legacy\_legacy\agents\technical\deployment_agent.py)
- [qa_agent.py](file://legacy\_legacy\agents\technical\qa_agent.py)
...
**Diagram sources**
- [cto_alex.py](file://legacy\_legacy\agents\business\cto_alex.py)
- [base_agent.py](file://legacy\_legacy\agents\base_agent\base_agent.py)
...
**Section sources**
- [cto_alex.py](file://legacy\_legacy\agents\business\cto_alex.py)
- [cto_alex.md](file://legacy\_legacy\agents\business\cto_alex.md)
