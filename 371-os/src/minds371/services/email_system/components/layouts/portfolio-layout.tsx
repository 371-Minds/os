    ...
    >
      ...
      <div className="portfolio-layout__container">
        ...
        <div className="portfolio-layout__main">
          ...
          {/* Content Area */}
          <main className="portfolio-layout__content">
            {children}
          </main>
          
          {/* Sidebar (if provided) */}
          {sidebar && (
            <aside className="portfolio-layout__sidebar">
              {sidebar}
            </aside>
          )}
    ...
    <div className="portfolio-hero" style={heroStyle}>
      ...
      <div className="portfolio-hero__content">
        ...
        <div className="portfolio-hero__text">
          ...
          {tagline && (
            <p className="portfolio-hero__tagline">{tagline}</p>
          )}
              ...
              <div className="project-card__image">
                ...
                <div className="project-card__overlay">
                  <div className="project-card__actions">
                    {project.liveUrl && (
                      <a href={project.liveUrl} className="project-action project-action--live">
                        View Live
                      </a>
                    )}
                    {project.codeUrl && (
                      <a href={project.codeUrl} className="project-action project-action--code">
                        View Code
                      </a>
                    )}
                  </div>
