...
async function testMongoDBConnection() {
  ...
  try {
    ...
    const localUri =
      ...
      'mongodb://root:rootpassword371@localhost:27017/os371?authSource=admin';
    ...
    // Test read operation
    const retrievedDoc = await testCollection.findOne({
      _id: result.insertedId,
    });
    console.log(
      `📖 Test document retrieved: ${retrievedDoc ? '✅ Success' : '❌ Failed'}`,
    );
