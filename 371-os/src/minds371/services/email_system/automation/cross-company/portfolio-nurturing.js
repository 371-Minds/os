...
class PortfolioNurturingCampaigns {
    ...
    async sendNurturingEmail(contact, emailConfig, segment) {
        ...
        console.log('Sending nurturing email:', emailConfig.subject, 'to:', contact.email);
        
        const personalizedEmail = this.personalizeNurturingEmail(emailConfig, contact, segment);
    ...
    personalizeNurturingEmail(emailConfig, contact, segment) {
        ...
        subject = subject.replace('{{contactName}}', contact.name || 'Valued Partner');
