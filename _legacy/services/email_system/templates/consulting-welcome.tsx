...
export const ConsultingWelcome: React.FC<ConsultingWelcomeProps> = ({
  ...
  return (
    ...
    >
      ...
      <p>
        Welcome to Vision2Results! We're excited to partner with you on your
        transformation journey. This email confirms the start of our consulting
        engagement and outlines what you can expect in the coming weeks.
      </p>
      ...
      >
        ...
        <ul style={{ listStyle: 'none', padding: '0' }}>
          <li>
            <strong>Lead Consultant:</strong> {consultantName}
          </li>
          <li>
            <strong>Project Kickoff:</strong> {kickoffDate}
          </li>
          <li>
            <strong>Scope:</strong> {projectScope}
          </li>
        </ul>
      </div>
      ...
      <p>
        We're committed to delivering measurable results and transforming your
        vision into reality. If you have any questions before our kickoff,
