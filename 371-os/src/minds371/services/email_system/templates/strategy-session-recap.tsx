...
export const StrategySessionRecap: React.FC<StrategySessionRecapProps> = ({
  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', maxWidth: '600px', margin: '0 auto' }}>
      ...
      <p>
        Thank you for the productive strategy session on {sessionDate}. This recap summarizes 
        our key discussions, findings, and the strategic direction we've outlined for your organization.
      </p>
      ...
      <div style={{ backgroundColor: '#e8f5e8', padding: '20px', borderRadius: '5px', margin: '20px 0' }}>
        <h3 style={{ color: '#2c3e50', marginTop: '0' }}>Strategic Next Steps</h3>
        <ol>
      ...
      <p>
        Based on our session, we'll be developing a comprehensive implementation roadmap 
        that aligns with your strategic objectives. This will include detailed timelines, 
        resource requirements, and success metrics.
      </p>
      
      <p>
        I'll be following up within 48 hours with additional documentation and our 
        preliminary roadmap draft for your review.
      </p>
      
      <p>
        Best regards,<br/>
        {consultantName}<br/>
        Senior Strategy Consultant<br/>
        Vision2Results
      </p>
