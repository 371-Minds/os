...
export const TournamentInvitation: React.FC<TournamentInvitationProps> = ({
  ...
  const urgencyLevel =
    spotsRemaining <= 10 ? 'high' : spotsRemaining <= 50 ? 'medium' : 'low';
  ...
  const getUrgencyStyle = () => {
    switch (urgencyLevel) {
      ...
      default:
        return { backgroundColor: '#00ff88', color: '#000000' };
    }
  };
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '20px', backgroundColor: '#1a1a1a' }}>
        ...
        >
          ...
          >
            ...
            >
              <div>
                <strong>Game:</strong>{' '}
                <span style={{ color: '#00ff88' }}>{gameTitle}</span>
              </div>
              <div>
                <strong>Type:</strong>{' '}
                <span style={{ color: '#ffd700' }}>{tournamentType}</span>
              </div>
              <div>
                <strong>Skill Level:</strong>{' '}
                <span style={{ color: '#ff6b6b' }}>{skillRequirement}</span>
              </div>
              <div>
                <strong>Prize Pool:</strong>{' '}
                <span style={{ color: '#ffd700' }}>{prizePool}</span>
              </div>
            </div>
          </div>
        </div>
            ...
            >
              ...
              >
                {specialRules.map((rule, index) => (
                  <li
                    key={index}
                    style={{ marginBottom: '8px', color: '#cccccc' }}
                  >
                    ⚖️ {rule}
                  </li>
                ))}
        ...
        <p>
          This is your chance to showcase your skills on the big stage,{' '}
          {gamerTag}! We've seen your gameplay, and we know you have what it
          takes to compete with the best. Don't let this opportunity slip away!
        </p>
        ...
        <p>
          ...
          <strong style={{ color: '#e74c3c' }}>
            The EpicQuestHub Tournament Team
          </strong>
        </p>
